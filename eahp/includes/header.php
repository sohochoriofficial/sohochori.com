 ...
 ?>
  ...
  <header id="header" class="fixed-top">
    <div class="container d-flex align-items-center">
      ...
      <a href="index.php" class="logo me-auto"><img src="assets/images/sohochorilogo.jpg" alt="Sohochori Logo" style="height: 40px; vertical-align: middle;"><span style="color:rgb(11, 9, 129); font-size: 24px; font-weight: bold;">SOHOCHORI</span>
      </a>
